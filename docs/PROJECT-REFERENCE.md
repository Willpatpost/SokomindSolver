...
- Catalog schema: `2`
- Puzzles: **57** across **2** collections and **2** shards
- Difficulty counts: `tutorial` 4, `beginner` 14, `intermediate` 15, `advanced` 11, `expert` 8, `master` 5
...
- All scripts and styles: **500,000 gzip bytes**
- Largest asset: **100,000 gzip bytes**
- Solver worker: **82,000 gzip bytes**
- Nested engine worker: **95,000 gzip bytes**
