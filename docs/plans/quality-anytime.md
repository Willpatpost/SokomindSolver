...
| [sokomind-engine-worker.ts](../../src/solver/implementations/sokomind-engine-worker.ts) | Browser worker dispatch | Apply equivalent lifecycle/protocol changes; verify actual filename before editing if source organization changes |
