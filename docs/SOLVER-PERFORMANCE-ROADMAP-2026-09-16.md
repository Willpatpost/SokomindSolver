...
| 5. Exact preprocessing | Partial: deadline fallback, live packed queue, pre-allocation checks, cancellation, dynamic PDB-cache accounting, IDA* cached cheap bounds recomputed in later contours | Reuse immutable preprocessing; useful-pattern selection; ordinary/tunnel A* cheap cutoffs |
