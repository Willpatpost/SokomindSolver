/**
 * V3 beam permutation v2: deeper lookahead, traffic penalty, block-first sorting.
 */
...
// Test v2 beam with deeper lookahead at various widths
for (const width of [100, 200, 500]) {
  console.log(`\n--- Beam perm v2 (width=${width}) ---`);
