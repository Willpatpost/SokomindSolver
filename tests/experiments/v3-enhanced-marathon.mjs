/**
 * Enhanced marathon: combines weighted heuristic + bidirectional permutation
 * + large windows for maximum walk reduction.
 * Phase 1: plan-macro-beam
 * Phase 2: Quick standard rewrite
 * Phase 3: Iterative rounds with enhanced permutation features
 */
...
// Phase 3: Enhanced iterative rewrite with escalating parameters
const tiers = [
  // Tier 1: medium windows with weighted heuristic + bidirectional
  { name: "medium-weighted", hWeight: 2, bidir: true, mbWeight: 1.5, coarse: false,
    permVis: 400_000, permWin: [16, 32, 48, 64], perPerm: 6000,
  ...
  // Tier 2: large windows, higher weight, coarse identity
  { name: "large-coarse", hWeight: 3, bidir: true, mbWeight: 2.0, coarse: true,
    permVis: 600_000, permWin: [32, 48, 64, 96, 128], perPerm: 10000,
  ...
  // Tier 3: mega windows, coarse identity
  { name: "mega-coarse", hWeight: 3, bidir: true, mbWeight: 2.0, coarse: true,
    permVis: 1_000_000, permWin: [48, 64, 96, 128, 160], perPerm: 15000,
  ...
  // Tier 4: ultra with very high weight + coarse identity for deep exploration
  { name: "ultra-coarse", hWeight: 5, bidir: true, mbWeight: 2.5, coarse: true,
    permVis: 1_500_000, permWin: [64, 96, 128, 160], perPerm: 20000,
