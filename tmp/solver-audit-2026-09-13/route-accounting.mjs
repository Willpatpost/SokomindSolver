...
writeFileSync("tmp/solver-audit-2026-09-13/route-accounting.json", JSON.stringify(output, null, 2) + "\n");
...
`;
writeFileSync("tmp/solver-audit-2026-09-13/route-accounting.md", report);
